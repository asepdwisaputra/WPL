...
<html lang="en">
	<head>
		...
		<link
			rel="icon"
			href="https://upload.wikimedia.org/wikipedia/commons/5/56/VfL_Wolfsburg_Logo.png"
		/>
		<style>
			html,
			body {
...
Kode PHP pertama aku <b>`echo "Hello, You!"`</b>.
Kenapa bukan <b>`Hello World!`</b>???
Because, <b>`You`</b> are my <b>`World`</b>💖😻🤗 
          </pre>
